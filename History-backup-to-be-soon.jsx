  ...
  return (
    <div>
      ...
      <div class="footer-MaQ2GE">
        ...
        <a href="https://www.linkedin.com/company/sendfriend/" target="_blank" rel="noreferrer"
          ><div class="linked-in-4ykixH montserrat-medium-white-14px">| LinkedIn</div> </a
        ><a href="https://twitter.com/sendfriendinc" target="_blank" rel="noreferrer"
          ><div class="twitter-4ykixH montserrat-medium-white-14px">Twitter</div> </a
        ><a href="https://www.facebook.com/sendfriendinc/" target="_blank" rel="noreferrer"
          ><div class="facebook-4ykixH montserrat-medium-white-14px">Facebook</div>
        </a>
        <div class="rectangle-40-4ykixH"></div>
        <img class="learn-more-4ykixH smart-layers-pointers" src="img/learn-more-1@2x.png" />
        <div class="to-learn-more-about-send-friend-4ykixH montserrat-bold-white-32px">
          <span class="span0-uis1QI montserrat-bold-white-32px-2">To learn more about</span
          ><span class="span1-uis1QI montserrat-bold-caribbean-green-32px"> SendFriend</span>
        </div>
        <img class="line-1-4ykixH" src="img/line-1@1x.png" />
        <img class="asset-1bg1-1-2-4ykixH" src="img/asset-1bg1-1-2@2x.png" />
      </div>
      <img class="rectangle-42-MaQ2GE" src="img/rectangle-42@1x.png" />
      ...
      <div class="team1-MaQ2GE">
        ...
        <div class="bio-x0uKuI smart-layers-pointers">
          ...
          <div class="founderceo-rMTOpx montserrat-normal-white-14px">Founder/CEO</div>
        </div>
      </div>
      ...
      <div class="group-108-MaQ2GE">
        ...
        <div class="rippl-4HT3Ns">
          <img class="vector-sxgOHs" src="img/vector-2@2x.png" />
          <img class="vector-Zn1KGW" src="img/vector-3@2x.png" />
          <img class="vector-C5dW3h" src="img/vector-4@2x.png" />
          <img class="vector-UAVug9" src="img/vector-5@2x.png" />
          <img class="vector-SoUWCr" src="img/vector-6@2x.png" />
          <img class="vector-9QKRtk" src="img/vector-7@2x.png" />
          <img class="vector-Rl46Pg" src="img/vector-8@2x.png" />
        </div>
      ...
      <img class="man_phone_sendy-1-MaQ2GE bp1-animate-enter" show-on-scroll src="img/man-phone-sendy-1@1x.png" />
      <div class="group-92-MaQ2GE">
        ...
        <img class="learn-more-iVdtxd" src="img/learn-more@2x.png" />
      </div>
      <img class="background-img-MaQ2GE" src="img/background-img@1x.png" />
      <div class="rectangle-87-MaQ2GE bp1-animate-enter1" show-on-scroll></div>
      <div class="header-text-MaQ2GE bp1-animate-enter2" show-on-scroll>
      ...
      <div class="navbar-MaQ2GE">
        <div class="rectangle-128-OBUuxy"></div>
        <div class="rectangle-125-OBUuxy"></div>
        <img class="logo_menu-1-OBUuxy" src="img/logo-menu-1@2x.png" />
        <a href="javascript:ShowOverlay('dropdown-menu', 'animate-appear');">
          <div class="company-dropdown-OBUuxy">
            <img class="vector-1sK89J" src="img/vector-41@2x.png" />
            <div class="company-1sK89J montserrat-bold-white-14px">COMPANY</div>
          </div></a
        >
        <a href="javascript:ShowOverlay('frame-6', 'animate-appear');">
        <div class="login-button-default-OBUuxy smart-layers-pointers">
          <div class="rectangle-100-067scl smart-layers-pointers border-5px-caribbean-green"></div>
          <div class="login-067scl montserrat-bold-white-14px">LOGIN</div>
        </div>
        </a>
        <a href="/#/#platform-section">
        <div class="platform-OBUuxy montserrat-bold-white-14px">PLATFORM</div>
        </a>
        <div class="partners-OBUuxy montserrat-bold-white-14px">PARTNERS</div>
        <div class="contact-us-OBUuxy montserrat-bold-white-14px">CONTACT US</div>
      </div>
      <div class="top-header-MaQ2GE">
        <div class="rectangle-97-xZpYYr"></div>
        <div class="bxbxl-facebook-xZpYYr">
          <a href="https://www.facebook.com/sendfriendinc/" target="_blank" rel="noreferrer"
            ><img class="vector-u6dsiS" src="img/vector-59@2x.png" />
          </a>
        </div>
        <a href="https://twitter.com/sendfriendinc" target="_blank" rel="noreferrer">
          <div class="ant-designtwitter-outlined-xZpYYr">
            <img class="vector-vC3QWf" src="img/vector-60@2x.png" /></div></a
        ><a href="https://www.linkedin.com/company/sendfriend/" target="_blank" rel="noreferrer"
    ...
    <div class="iphone-13-13-pro-2 screen">
      ...
      <div class="group-92-fvgTPB">
        ...
        <div class="group-129-qAu7DX">
          <div class="ant-designcheck-circle-outlined-4gk5Ac">
            <img class="vector-SjxLM3" src="img/vector@2x.png" />
            <img class="vector-Nr3HrX" src="img/vector-1@2x.png" />
          </div>
          ...
          <div class="ant-designcheck-circle-outlined-y4m6lC">
            <img class="vector-Nrxjr9" src="img/vector@2x.png" />
            <img class="vector-F5NtSd" src="img/vector-1@2x.png" />
          </div>
          <div class="ant-designcheck-circle-outlined-CYvggm">
            <img class="vector-f5plpI" src="img/vector@2x.png" />
            <img class="vector-b78BhJ" src="img/vector-1@2x.png" />
          </div>
        </div>
      ...
      <div class="frame-130-fvgTPB">
        ...
        <div class="rippl-0qRsxd">
          <img class="vector-okSf4N" src="img/vector-8@2x.png" />
          <img class="vector-xsNFf1" src="img/vector-9@2x.png" />
          <img class="vector-mhiDex" src="img/vector-10@2x.png" />
          <img class="vector-CLTMkk" src="img/vector-11@2x.png" />
          <img class="vector-Zt3SYh" src="img/vector-12@2x.png" />
          <img class="vector-fJOXxe" src="img/vector-13@2x.png" />
          <img class="vector-p20DDw" src="img/vector-14@2x.png" />
        </div>
        <img
      ...
      <div class="team2-fvgTPB">
        <img class="image-3-Hk57m7 smart-layers-pointers" src="img/image-3@2x.png" />
      ...
      <div class="footer-fvgTPB">
        ...
        <div class="original-logo-x2srWP">
          <div class="layer-2-gaweBy">
            <div class="logo-kcYvq6">
              <div class="group-106-uwEbxC">
                <img class="vector-zCLskx" src="img/vector-74@2x.png" />
                <img class="vector-wPmqGd" src="img/vector-75@2x.png" />
                <img class="vector-C9Gx9S" src="img/vector-76@2x.png" />
                <img class="vector-N3Av8T" src="img/vector-77@2x.png" />
                <img class="vector-hXrOrS" src="img/vector-78@2x.png" />
                <img class="vector-7qMh8Z" src="img/vector-79@2x.png" />
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="frame-8-fvgTPB">
        <a href="javascript:ShowOverlay('mobile-menu', 'animate-appear');">
          <div class="hamburger-kq7cQe">
            <img class="vector-16-CypR7f" src="img/vector-16-1@2x.png" />
            <a href="javascript:HideOverlay('history', 'animate-disappear');" onclick="window.event.stopPropagation()"
              ><img class="vector-17-CypR7f" src="img/vector-16-1@2x.png" /> </a
            ><img class="vector-18-CypR7f" src="img/vector-16-1@2x.png" /></div
        ></a>
      </div>
      <div class="rectangle-125-fvgTPB"></div>
      <div class="original-logo-fvgTPB">
        <div class="layer-2-nNz1NT">
          <div class="logo-D47oV3">
            <div class="group-106-oFYHu4">
              <img class="vector-Zhy8rb" src="img/vector-80@2x.png" />
              <img class="vector-58r0Fk" src="img/vector-81@2x.png" />
              <img class="vector-cFxYio" src="img/vector-82@2x.png" />
              <img class="vector-C9KUpY" src="img/vector-83@2x.png" />
              <img class="vector-K9wxNk" src="img/vector-84@2x.png" />
              <img class="vector-FlahDb" src="img/vector-85@2x.png" />
            </div>
          </div>
        </div>
      </div>
      <div class="logo-title-fvgTPB">
        <div class="friend-paWV3d">
          <img class="vector-PDNKPZ" src="img/vector-86@2x.png" />
          <img class="vector-ll8YtX" src="img/vector-87@2x.png" />
          <img class="vector-iTspxk" src="img/vector-88@2x.png" />
          <img class="vector-Hx7N67" src="img/vector-89@2x.png" />
          <img class="vector-gXxJCA" src="img/vector-90@2x.png" />
          <img class="vector-kEkAi7" src="img/vector-91@2x.png" />
          <img class="vector-xd8f53" src="img/vector-92@2x.png" />
        </div>
        <div class="send-paWV3d">
          <img class="vector-GqVrow" src="img/vector-93@2x.png" />
          <img class="vector-ss8Kzs" src="img/vector-94@2x.png" />
          <img class="vector-83fjx2" src="img/vector-95@2x.png" />
          <img class="vector-42njtV" src="img/vector-96@2x.png" />
        </div>
      </div>
    </div>
