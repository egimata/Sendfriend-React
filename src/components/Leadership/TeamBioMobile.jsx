...
const TeamBioMobile = () => {
    const altimg = "SendFriend Team"
    return (
        <>
        <div id="david" className="team1-KMEx58">
        <img alt={altimg} className="image-2-HuxJgL smart-layers-pointers" src="img/leadership/image-2-1@2x.png" />
        <div className="bio-HuxJgL smart-layers-pointers">
          <div className="rectangle-45-mWcmHb"></div>
          <div className="david-lighton-mWcmHb valign-text-middle montserrat-semi-bold-white-9px">David Lighton</div>
          <div className="cofounderceo-mWcmHb valign-text-middle montserrat-normal-white-7px">Cofounder/CEO</div>
        </div>
        <div className="david-lighton-is-sen-HuxJgL">
        ...
        <div className="he-also-sits-on-the-HuxJgL">
      ...
      <div id="roy" className="team2-KMEx58">
        <img alt={altimg} className="image-3-UfW2Ke smart-layers-pointers" src="img/leadership/image-3-2@2x.png" />
        <div className="bio-UfW2Ke smart-layers-pointers">
          <div className="rectangle-45-irWUfd"></div>
          <div className="roy-vivasi-irWUfd valign-text-middle montserrat-semi-bold-white-9px">Roy Vivasi</div>
          <div className="cofoundercto-irWUfd valign-text-middle montserrat-normal-white-7px">Cofounder/CTO</div>
        </div>
        <div className="roy-vivasi-joined-se-UfW2Ke montserrat-normal-white-6-5px">
      ...
      <div className="from-2010-2014-he-wo-KMEx58 montserrat-normal-white-6-5px">
      ...
      <div id="will" className="team5-KMEx58">
        <img alt={altimg} className="img_8101-1-1-oxfA6n smart-layers-pointers" src="img/leadership/img-8101--1--1-1@2x.png" />
        <div className="bio-oxfA6n smart-layers-pointers">
          <div className="will-ferrer-WybKbN valign-text-middle montserrat-semi-bold-white-9px">Will Ferrer</div>
          <div className="director-of-operations-and-strategy-WybKbN valign-text-middle montserrat-normal-white-7px">
            Director of Operations&nbsp;&nbsp;and Strategy
          </div>
        </div>
        <div className="will-ferrer-is-send-oxfA6n montserrat-normal-white-6-5px">
      ...
      <div id="sandra" className="team6-KMEx58">
        <img alt={altimg} className="image-5-2cFUi5 smart-layers-pointers" src="img/leadership/image-5-1@2x.png" />
        <div className="bio-2cFUi5 smart-layers-pointers">
          <div className="rectangle-45-erd8Rf"></div>
          <div className="sandra-ro-erd8Rf valign-text-middle montserrat-semi-bold-white-9px">Sandra Ro</div>
          <div className="director-erd8Rf valign-text-middle montserrat-normal-white-7px">Director</div>
        </div>
        <div className="sandra-ro-is-the-cur-2cFUi5 montserrat-normal-white-6-5px">
      ...
      <div id="satwik" className="team7-KMEx58">
        <img alt={altimg} className="image-3-cx6SIn smart-layers-pointers" src="img/leadership/image-3-3@2x.png" />
        <div className="bio-cx6SIn smart-layers-pointers">
          <div className="rectangle-45-R0XJ2c"></div>
          <div className="satwik-seshasai-R0XJ2c valign-text-middle montserrat-semi-bold-white-9px">Satwik Seshasai</div>
          <div className="director-R0XJ2c valign-text-middle montserrat-normal-white-7px">Director</div>
        </div>
        <div className="satwik-seshasai-is-t-cx6SIn montserrat-normal-white-6-5px">
      ...
      <div id="rafal" className="team4-KMEx58">
        <img alt={altimg} className="rafal-1-mW9Xxr smart-layers-pointers" src="img/leadership/rafal-1-1@2x.png" />
        <div className="bio-mW9Xxr smart-layers-pointers">
          <div className="rafal-petsch-iaezLb valign-text-middle montserrat-semi-bold-white-9px">Rafal Petsch</div>
          <div className="general-manager-of-polish-operations-iaezLb valign-text-middle montserrat-normal-white-7px">
            General Manager of Polish Operations
          </div>
        </div>
        <div className="rafal-petsch-is-send-mW9Xxr montserrat-normal-white-6-5px">
        ...
        <div className="the-remainder-of-his-mW9Xxr montserrat-normal-white-6-5px">
