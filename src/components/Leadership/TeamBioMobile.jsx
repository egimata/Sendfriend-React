...
const TeamBioMobile = () => {
    ...
    return (
        <>
        <div id="david" class="team1-KMEx58">
        <img alt={altimg} class="image-2-HuxJgL smart-layers-pointers" src="img/leadership/image-2-1@2x.png" />
      ...
      <div id="roy" class="team2-KMEx58">
        <img alt={altimg} class="image-3-UfW2Ke smart-layers-pointers" src="img/leadership/image-3-2@2x.png" />
      ...
      <div id="will" class="team5-KMEx58">
        <img alt={altimg} class="img_8101-1-1-oxfA6n smart-layers-pointers" src="img/leadership/img-8101--1--1-1@2x.png" />
      ...
      <div id="sandra" class="team6-KMEx58">
        <img alt={altimg} class="image-5-2cFUi5 smart-layers-pointers" src="img/leadership/image-5-1@2x.png" />
      ...
      <div id="satwik" class="team7-KMEx58">
        <img alt={altimg} class="image-3-cx6SIn smart-layers-pointers" src="img/leadership/image-3-3@2x.png" />
      ...
      <div id="rafal" class="team4-KMEx58">
        <img alt={altimg} class="rafal-1-mW9Xxr smart-layers-pointers" src="img/leadership/rafal-1-1@2x.png" />
