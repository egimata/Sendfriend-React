    ...
    <div>
        ...
        <div class="contact-us screen">
            ...
            <div class="bxbxl-facebook-64rcff">
                ...
                ><img class="vector-Hyky9U" src="img/vector-1@2x.svg" />
                </a>
            </div>
            <a href="https://twitter.com/sendfriendinc" target="_blank">
                <div class="ant-designtwitter-outlined-64rcff">
                <img class="vector-molF0M" src="img/vector-32@2x.svg" /></div></a
            ><a href="https://www.linkedin.com/company/sendfriend/" target="_blank"
                ><img class="vector-64rcff" src="img/vector-8@2x.svg" />
            </a>
            </div>
            <div class="navbar-q2xQ3x">
            <img class="vector-PUJjp0" src="img/vector-9@1x.svg" />
            <div class="company-dropdown-PUJjp0">
                <img class="vector-BlwT8x" src="img/vector-16@2x.svg" />
            ...
            <div class="original-logo-PUJjp0">
                <div class="layer-2-psLxCl">
                <div class="logo-NfVyzz">
                    <div class="group-106-M7cpkh">
                    <img class="vector-dsJSyI" src="img/vector-5@2x.svg" />
                    <img class="vector-WwBTok" src="img/vector-80@2x.svg" />
                    <img class="vector-Z83skq" src="img/vector-15@2x.svg" />
                    <img class="vector-mO8FNv" src="img/vector-16@2x.svg" />
                    <img class="vector-xrwf3w" src="img/vector-41@2x.svg" />
                    <img class="vector-GBzzGx" src="img/vector-42@2x.svg" />
                    </div>
                </div>
                </div>
            </div>
            <div class="logo-title-PUJjp0">
                <div class="friend-x6AXLC">
                <img class="vector-73ZRCU" src="img/vector-11@2x.svg" />
                <img class="vector-h9H4ft" src="img/vector-86@2x.svg" />
                <img class="vector-xydcn4" src="img/vector-45@2x.svg" />
                <img class="vector-iuxHV6" src="img/vector-22@2x.svg" />
                <img class="vector-yCKGw9" src="img/vector-15@2x.svg" />
                <img class="vector-9hQsRp" src="img/vector-48@2x.svg" />
                <img class="vector-KgF1Pv" src="img/vector-49@2x.svg" />
                </div>
                <div class="send-x6AXLC">
                <img class="vector-dVwTez" src="img/vector-92@2x.svg" />
                <img class="vector-F74H0I" src="img/vector-19@2x.svg" />
                <img class="vector-WIR1eG" src="img/vector-20@2x.svg" />
                <img class="vector-FP9ihZ" src="img/vector-21@2x.svg" />
                </div>
            </div>
            ...
            <img class="send-button-q2xQ3x smart-layers-pointers" src="img/send-button@2x.svg" />
            ...
            <div class="group-45-FjfUj9">
                <img class="path-45-3cxTM6" src="img/path-45@2x.svg" />
                <img class="ellipse-8-3cxTM6" src="img/ellipse-8@2x.svg" />
                <img class="path-46-3cxTM6" src="img/path-46@2x.svg" />
                <img class="ellipse-9-3cxTM6" src="img/ellipse-9@2x.svg" />
                <img class="path-47-3cxTM6" src="img/path-47@2x.svg" />
                <img class="path-48-3cxTM6" src="img/path-48@2x.svg" />
                <img class="path-49-3cxTM6" src="img/path-49@2x.svg" />
                <img class="path-50-3cxTM6" src="img/path-50@2x.svg" />
            </div>
            <img class="line-1-FjfUj9" src="img/line-1@1x.svg" />
            ...
            <img
                ...
                src="img/contact-us-button-footer@2x.svg"
            />
            </div>
        </div>
        </div>
