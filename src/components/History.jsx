      ...
      <div class="container-center-horizontal">
        <div class="history screen">
          <div class="footer-MaQ2GE">
            ...
            <img
              class="learn-more-4ykixH smart-layers-pointers"
            ...
            />
            <div class="friend-4ykixH">
              <img class="vector-6tY8to" src="img/vector-5@2x.svg" />
              <img class="vector-093mOL" src="img/vector-33@2x.svg" />
              <img class="vector-vRePKK" src="img/vector-7@2x.svg" />
              <img class="vector-7xueZj" src="img/vector-8@2x.svg" />
              <img class="vector-G5Wci2" src="img/vector-9@2x.svg" />
              <img class="vector-oN8fx3" src="img/vector-10@2x.svg" />
              <img class="vector-P1xWVe" src="img/vector-11@2x.svg" />
            </div>
            <div class="send-4ykixH">
              <img class="vector-fakOcs" src="img/vector-39@2x.svg" />
              <img class="vector-YpzznW" src="img/vector-13@2x.svg" />
              <img class="vector-x0e75E" src="img/vector-14@2x.svg" />
              <img class="vector-ieOzu3" src="img/vector-15@2x.svg" />
            </div>
            <div class="original-logo-4ykixH">
              <div class="layer-2-Vs0NEv">
                <div class="logo-DuyOyN">
                  <div class="group-106-5dFxxW">
                    <img class="vector-YG3ilo" src="img/vector-16@2x.svg" />
                    <img class="vector-bxEgO1" src="img/vector-80@2x.svg" />
                    <img class="vector-jtuOWf" src="img/vector-18@2x.svg" />
                    <img class="vector-Ho4VtY" src="img/vector-19@2x.svg" />
                    <img class="vector-xKKCxx" src="img/vector-20@2x.svg" />
                    <img class="vector-jsjOWk" src="img/vector-21@2x.svg" />
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="rippl-MaQ2GE">
            <img class="vector-AxaL8z" src="img/vector-22@2x.svg" />
            <img class="vector-NW1AgA" src="img/vector-23@2x.svg" />
            <img class="vector-r2GxFL" src="img/vector-24@2x.svg" />
            <img class="vector-R8KZxN" src="img/vector-25@2x.svg" />
            <img class="vector-bokxFF" src="img/vector-26@2x.svg" />
            <img class="vector-VRxt1D" src="img/vector-27@2x.svg" />
            <img class="vector-9kjAdx" src="img/vector-28@2x.svg" />
          </div>
          ...
          <div class="group-92-MaQ2GE">
            ...
            <img class="learn-more-iVdtxd" src={learn_more_svg} />
          </div>
          ...
          <div class="navbar-MaQ2GE">
            ...
            <a href="javascript:ShowOverlay('frame-6', 'animate-appear');">
              <div class="login-button-default-OBUuxy smart-layers-pointers">
                <div class="rectangle-100-067scl smart-layers-pointers"></div>
